...
VALUES
    ('5만원 이상 구매 시 5,000원 할인', '일반 쿠폰', 100000, 0, 5000, 50000, NOW(), DATE_ADD(NOW(), INTERVAL 30 DAY), NOW(), NOW()),
    ('3만원 이상 구매 시 3,000원 할인', '일반 쿠폰', 100000, 0, 3000, 30000, NOW(), DATE_ADD(NOW(), INTERVAL 30 DAY), NOW(), NOW()),
    ('2만원 이상 구매 시 2,000원 할인', '일반 쿠폰', 100000, 0, 2000, 20000, NOW(), DATE_ADD(NOW(), INTERVAL 30 DAY), NOW(), NOW()),
    ('1만원 이상 구매 시 1,000원 할인', '일반 쿠폰', 100000, 0, 1000, 10000, NOW(), DATE_ADD(NOW(), INTERVAL 30 DAY), NOW(), NOW());
